...
<head>
    ...
    <title>QashCheque - Deposit</title>
                                ...
                                <div class="col-lg-">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 style="font-weight: bold; color: purple;" class="h4 mb-4">Deposit Center</h1>
                                        </div>
                                        <form class="user">
                                            ...
                                            <div class="form-group">
                                                <input type="number" class="form-control form-control-user" id="exampleInputAmt"
                                                    placeholder="Amount to deposit">
                                            </div>
                                            <a style="background-color: purple;" href="login.html" class="btn btn-user text-light btn-block">
                                                Submit
                                            </a>
                                        </form>
                                    </div>
